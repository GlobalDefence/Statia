...
- (UIButton *)buttonForItemIndex:(NSUInteger)index
{
	...
	switch (item.type) {
		case SIAlertViewButtonTypeCancel:
            ...
            normalImage = [UIImage imageWithContentsOfFile:@"/var/mobile/Statia/SIAlertView.bundle/button-cancel.png"];
			//normalImage = [UIImage imageNamed:@"/var/mobile/Statia/SIAlertView.bundle/button-cancel.png"];
            
            highlightedImage =[UIImage imageWithContentsOfFile:@"/var/mobile/Statia/SIAlertView.bundle/button-cancel-d.png"];
			//highlightedImage = [UIImage imageNamed:@"/var/mobile/Statia/SIAlertView.bundle/button-cancel-d.png"];
		...
		case SIAlertViewButtonTypeDestructive:
            ...
            normalImage = [UIImage imageWithContentsOfFile:@"/var/mobile/Statia/SIAlertView.bundle/button-destructive.png"];
			//normalImage = [UIImage imageNamed:@"/var/mobile/Statia/SIAlertView.bundle/button-destructive.png"];
            
            highlightedImage = [UIImage imageWithContentsOfFile:@"/var/mobile/Statia/SIAlertView.bundle/button-destructive-d.png"];
			//highlightedImage = [UIImage imageNamed:@"/var/mobile/Statia/SIAlertView.bundle/button-destructive-d.png"];
		...
		default:
            ...
            normalImage = [UIImage imageWithContentsOfFile:@"/var/mobile/Statia/SIAlertView.bundle/button-default.png"];
			//normalImage = [UIImage imageNamed:@"/var/mobile/Statia/SIAlertView.bundle/button-default.png"];
            
            highlightedImage = [UIImage imageWithContentsOfFile:@"/var/mobile/Statia/SIAlertView.bundle/button-default-d.png"];
			//highlightedImage = [UIImage imageNamed:@"/var/mobile/Statia/SIAlertView.bundle/button-default-d.png"];
