...
static void _logos_method$_ungrouped$SBAppSwitcherPageView$touchesBegan$withEvent$(SBAppSwitcherPageView* self, SEL _cmd, NSSet * touches, UIEvent * event) {
